...
export const WEBSITE_URL = ensureProtocol(process.env.NEXT_PUBLIC_WEBSITE_URL) || "https://slotly.vercel.app";
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "Slotly";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "support@slotly.app";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "Slotly";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "Slotly";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "Slotly";
